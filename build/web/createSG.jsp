...
<html lang="en">
    ...
    <body>
        <div>
            ...
            <form class="form-1" action="createSG?type=<%
                ...
                <p class="field">
                    <input type="text" name="size" maxlength="2" placeholder="Size">
                ...
                <p class="field">
                    <textarea rows="3" cols="30" name="description" style="resize:none" maxlength="80" placeholder="Description"></textarea>
